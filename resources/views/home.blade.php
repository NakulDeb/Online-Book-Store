							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="/{{$product->product_image}}" style="height:200px; width:140px" alt="" />
								...
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										...
										<li><a href="{{URL::to('/view-details/'.$product->product_id)}}"><i class="fa fa-plus-square"></i>View Details</a></li>
									</ul>
								</div>
							</div>
						</div>
