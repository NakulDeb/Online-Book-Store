					...
					<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<tr>
								...
								<td class="center">{{$result->user_first_name}}</td>
								<td class="center">{{$result->user_last_name}}</td>
								<td class="center">{{$result->user_phone}}</td>
								<td class="center">{{$result->user_Address}}</td>

								<td class="center">
									<a class="btn btn-danger" title="Delete" href="{{URL::to('/delete-user/'.$result->user_id)}}" id="delete">
