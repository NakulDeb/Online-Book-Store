				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
								  ...
								  <th class="center" width="25%">Product Name</th>
								  <th class="center" width="12%">Writer Name</th>
								  <th class="center" width="10%">Product Image</th>
								  <th class="center" width="5%">Product Price</th>
								  <th class="center" width="5%">Catetory Name</th>
								  <th class="center" width="5%">Publication Status</th>
						  ...
						  <tbody>
							<tr>
								...
								<td class="center">{{$result->writer_name}}</td>
								<td> <img src="{{URL::to($result->product_image)}}" style="height:80px; width:80px"/></td>
								<td class="center">{{$result->product_price}}</td>
								...
								@else
								<td class="center">
									<span class="label label-denger">Deactive</span>
								</td>
								@endif
								<td class="center">
								@if($result->publication_status==1)
									<a class="btn btn-denger" title="Set De-Active" href="{{URL::to('/set-deactive-product/'.$result->product_id)}}">
										<i class="halflings-icon white zoom-down"></i>  
									</a>
								@else
									<a class="btn btn-success" title="Set Active" href="{{URL::to('/set-active-product/'.$result->product_id)}}">
										<i class="halflings-icon white zoom-up"></i>  
									</a>
								@endif
									<a class="btn btn-info" title="Edit" href="{{URL::to('/edit-product/'.$result->product_id)}}">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" title="Delete" href="{{URL::to('/delete-product/'.$result->product_id)}}" id="delete">
					  ...
					  <div class="span12 center">
						<div class="dataTables_info dataTables_paginate paging_bootstrap pagination">{{$data->links()}}</div>
					</div>        
					</div>
