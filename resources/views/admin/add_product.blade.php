						...
						{{csrf_field()}}
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead" name="product_name" required>
								</div>
							</div>

							<div class="control-group">
							  <label class="control-label" for="typeahead">Writer Name</label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead" name="writer_name"required>
								</div>
							</div>
                            ...
                            <div class="control-group">
							  ...
							  <div class="controls">
								<input type="number" class="span6 typeahead" id="typeahead" name="product_price" required>
							  </div>
							</div>

							<div class="control-group">
								<label class="control-label" name="product_category" for="selectError3">Product Category</label>
								<div class="controls">
							...
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Product Descriptions</label>
							  <div class="controls">
