			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-content">
						...
						<form class="form-horizontal" action="{{url('save-announcement')}}" method="get">
						{{csrf_field()}}
						  <fieldset>

							<div class="control-group">
							  <label class="control-label" for="typeahead" >Announcement Title</label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead" name="announcement_title" data-provide="typeahead" data-items="4" required>
							  </div>
							</div>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead" name="announcement_details" rows="3"required>
							  </div>
							</div>

							<div class="control-group">
							  <label class="control-label" for="typeahead" >Announcement Hyper Link</label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead" name="announcement_hyperlink" data-provide="typeahead" data-items="4" required>
							  </div>
							</div>
