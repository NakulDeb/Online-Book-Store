			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-content">
						...
						<form class="form-horizontal" action="{{url('save-category')}}" method="get">
						{{csrf_field()}}
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead" name="category_name" data-provide="typeahead" data-items="4" required>
							  </div>
							</div>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="typeahead" name="category_description" rows="3"required>
							  </div>
							</div>
